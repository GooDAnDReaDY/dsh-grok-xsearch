...
let PKG_VERSION = '0.3.18'
try {
  PKG_VERSION = require('../package.json').version || '0.3.18'
} catch {
...
const DISK_CACHE_PATH = process.env.DSH_CACHE_DIR
  ? join(process.env.DSH_CACHE_DIR, 'dsh-grok-xsearch-cache.json')
  : join(tmpdir(), 'dsh-grok-xsearch-cache.json')
