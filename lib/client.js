        ...
        React.createElement('div', { className: 'gx-section-card' },
          ...
          enableCache ? React.createElement('div', { className: 'gx-bar-container' },
            ...
            React.createElement('div', { className: 'gx-bar-meta' },
              React.createElement('span', null, `TTL: ${cacheTtlSeconds}s | ${t('cache_hits')}: ${cacheStats.hits || 0} | ${t('cache_misses')}: ${cacheStats.misses || 0} | ${t('cache_hit_rate')}: ${cacheStats.hitRate || 0}%`),
              React.createElement('button', {
                type: 'button',
                className: 'gx-btn',
