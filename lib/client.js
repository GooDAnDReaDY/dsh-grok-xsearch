window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function FallbackChevron(props) {
      return h('svg', { width: 14, height: 14, viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', strokeWidth: 2, strokeLinecap: 'round', strokeLinejoin: 'round', className: props?.className }, h('polyline', { points: '6 9 12 15 18 9' }))
    }
    const Chevron = ChevronIcon || FallbackChevron

    const CSS = `
${CSS_MARKER}.gx-wrap{display:flex;flex-direction:column;gap:14px;font-family:inherit;color:var(--dsw-alias-label-primary)}.gx-wrap-compact{gap:10px}.gx-header{display:flex;flex-direction:column;gap:4px;padding-bottom:12px;border-bottom:1px solid var(--dsw-alias-border-l2)}.gx-header-title{display:flex;align-items:center;gap:8px;font-size:16px;font-weight:600}.gx-header-sub{font-size:12px;color:va
r(--dsw-alias-label-secondary)}.gx-section-card{background:var(--dsw-alias-bg-layer-1);border:1px solid var(--dsw-alias-border-l1);border-radius:10px;padding:14px;display:flex;flex-direction:column;gap:10px}.gx-section-title{display:flex;align-items:center;justify-content:space-between;font-size:13px;font-weight:600}.gx-section-desc{font-size:12px;color:var(--dsw-alias-label-secondary);line-height
:1.4}.gx-row{display:flex;align-items:center;gap:10px}.gx-grow{flex:1}.gx-grid-2{display:grid;grid-template-columns:1fr 1fr;gap:12px}.gx-badge{display:inline-flex;align-items:center;padding:2px 8px;border-radius:12px;font-size:11px;font-weight:600}.gx-badge-ok{background:var(--dsw-alias-success-bg,rgba(34,197,94,0.12));color:var(--dsw-alias-success,rgb(34,197,94))}.gx-badge-warn{background:var(--d
sw-alias-warning-bg,rgba(234,179,8,0.12));color:var(--dsw-alias-warning,rgb(234,179,8))}.gx-badge-neutral{background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-secondary)}.gx-btn{appearance:none;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-primary);padding:6px 14px;border-radius:6px;font-size:13px;font-weight:500;cursor
:pointer;display:inline-flex;align-items:center;gap:6px;text-decoration:none}.gx-btn:hover:not(:disabled){background:var(--dsw-alias-bg-layer-3);border-color:var(--dsw-alias-border-l3)}.gx-btn:disabled{opacity:0.5;cursor:not-allowed}.gx-btn-primary{background:var(--dsw-alias-brand,rgb(59,130,246));color:#fff;border-color:var(--dsw-alias-brand,rgb(59,130,246))}.gx-btn-primary:hover:not(:disabled){f
ilter:brightness(1.08)}.gx-btn-danger{color:var(--dsw-alias-danger,rgb(239,68,68));border-color:var(--dsw-alias-danger-bg,rgba(239,68,68,0.3))}.gx-btn-danger:hover:not(:disabled){background:var(--dsw-alias-danger-bg,rgba(239,68,68,0.1))}.gx-input,.gx-select{width:100%;box-sizing:border-box;background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-labe
l-primary);padding:7px 10px;border-radius:6px;font-size:13px;outline:none}.gx-input:focus,.gx-select:focus{border-color:var(--dsw-alias-brand,rgb(59,130,246))}.gx-input:disabled,.gx-select:disabled{opacity:0.6}.gx-chk{display:inline-flex;align-items:center;gap:8px;font-size:13px;cursor:pointer;user-select:none}.gx-chk input[type="checkbox"]{cursor:pointer;width:15px;height:15px;accent-color:var(--dsw-alias-brand,rgb(59,130,246))}.gx-link{appearance:none;background:none;border:none;color:var(--dsw-alias-brand,rgb(59,130,246));font-size:12px;cursor:pointer;padding:0;text-decoration:underline}.gx-link:hover{filter:brightness(1.15)}.gx-alert-bad{background:var(--dsw-alias-danger-bg,rgba(239,68,68,0.1));border:1px solid var(--dsw-alias-danger,rgb(239,68,68));color:var(--dsw-alias-danger,rgb(239,68,68));padding:8px 12px;border-radius:6px;font-size:12px}.gx-alert-ok{background:var(--dsw-alias-success-bg,rgba(34,197,94,0.12));border:1px solid var(--dsw-alias-success,rgb(34,197,94));color:var(--dsw-alias-success,rgb(34,197,94));padding:8px 12px;border-radius:6px;font-size:12px}.gx-bar-container{display:flex;flex-direction:column;gap:6px;background:var(--dsw-alias-bg-layer-2);padding:10px 12px;border-radius:8px;border:1px solid var(--dsw-alias-border-l2)}.gx-bar-head{display:flex;justify-content:space-between;font-size:12px}.gx-bar-track{width:100%;height:6px;background:var(--dsw-alias-bg-layer-3);border-radius:3px;overflow:hidden}.gx-bar-fill{height:100%;background:var(--dsw-alias-brand,rgb(59,130,246));border-radius:3px;transition:width 0.3s ease}.gx-bar-meta{display:flex;align-items:center;justify-content:space-between;font-size:11px;color:var(--dsw-alias-label-secondary)}.gx-card{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);border-radius:12px;overflow:hidden;margin-bottom:16px}.gx-card-head{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:14px 16px;cursor:pointer;user-select:none}.gx-card-head:hover{background:var(--dsw-alias-bg-layer-2)}.gx-card-left{display:flex;align-items:center;gap:12px;min-width:0}.gx-card-icon{width:28px;height:28px;display:flex;align-items:center;justify-content:center;font-size:18px}.gx-card-meta{display:flex;flex-direction:column;min-width:0}.gx-card-title-row{display:flex;align-items:center;gap:8px}.gx-card-title{font-size:14px;font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.gx-card-desc{font-size:12px;color:var(--dsw-alias-label-secondary);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;margin-top:2px}.gx-card-right{display:flex;align-items:center;gap:10px}.gx-chev{transition:transform 0.2s ease;color:var(--dsw-alias-label-secondary);width:16px;height:16px}.gx-chev-open{transform:rotate(180deg)}.gx-body{border-top:1px solid var(--dsw-alias-border-l2);margin:0 16px;padding:12px 0 16px}.gx-collapse-btn{appearance:none;background:none;border:none;padding:4px 0;cursor:pointer;display:flex;align-items:center;justify-content:space-between;width:100%;color:var(--dsw-alias-label-secondary);font-size:13px;font-weight:500}.gx-collapse-btn:hover{color:var(--dsw-alias-label-primary)}`
    ...
    function UpdaterBlock(props) {
      ...
      const currentVer = status?.currentVersion || '0.3.19'
