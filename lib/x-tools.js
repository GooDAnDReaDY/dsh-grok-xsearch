...
export function createAuthorProfileTool({ getContext, getConfig, runSearch, getAccessToken, defineTool = (t) => t }) {
  return defineTool({
...
export function createTrendingTopicsTool({ getContext, getConfig, runSearch, getAccessToken, defineTool = (t) => t }) {
  return defineTool({
    name: 'x_trending_topics',
    description: 'Discover real-time trending discussions, emerging narratives, and breaking topics on X (Twitter).',
    parameters: {
      domain: { type: 'string', description: "Topic domain (e.g. 'tech', 'ai', 'crypto', 'science', 'world', 'general'). Default: 'tech'." },
      region: { type: 'string', description: "Optional region or community focus (e.g. 'Global', 'US', 'EU', 'Asia')." },
...
export function createFactCheckNotesTool({ getContext, getConfig, runSearch, getAccessToken, defineTool = (t) => t }) {
  return defineTool({
