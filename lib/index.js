...
import { createAuthorProfileTool, createTrendingTopicsTool, createFactCheckNotesTool, normalizeToolParameters } from './x-tools.js'
...
export function apply(ctx, config) {
  ...
  const syncTools = () => {
    ...
    disposers.push(ctx.tools.register(compatibleDefineTool({
      name: 'x_search',
